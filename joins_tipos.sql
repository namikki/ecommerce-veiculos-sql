...
-- temp_tables.tabela_1 e temp_tables.tabela_2 (tras todos os dados da tabela a esquerda que correspondem ou não com a tabela a direita)
select * from temp_tables.tabela_1
select * from temp_tables.tabela_2

SELECT t1.cpf, t1.name, t2.state
FROM temp_tables.tabela_1 as t1 left join temp_tables.tabela_2 t2
ON 	t1.cpf = t2.cpf

-- (Exemplo 2) Utilize o INNER JOIN para fazer join entre as tabelas
-- temp_tables.tabela_1 e temp_tables.tabela_2 (apenas os dados totalmente correspondentes nas duas colunas)
SELECT t1.cpf, t1.name, t2.state
FROM temp_tables.tabela_1 as t1 inner join temp_tables.tabela_2 t2
ON 	t1.cpf = t2.cpf
...
FROM temp_tables.tabela_1 as t1 right join temp_tables.tabela_2 t2
ON 	t1.cpf = t2.cpf

-- (Exemplo 4) Utilize o FULL JOIN para fazer join entre as tabelas
-- temp_tables.tabela_1 e temp_tables.tabela_2
SELECT t1.cpf, t1.name, t2.state
FROM temp_tables.tabela_1 as t1 full join temp_tables.tabela_2 t2
ON 	t1.cpf = t2.cpf
